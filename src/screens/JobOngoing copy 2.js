            ...
            leadDataContext.bookingDetails?.status === 'Project Completed' ? (
              <>
                ...
                >
                  ...
                  ) : /* 2) APPROVED (and has delta) → Old/Change/New */
                      ...
                      <View style={styles.rowBetween}>
                        ...
                        <Text
                          style={[
                            styles.amountDue,
                            {
                              color: approvedChangeDelta < 0 ? 'red' : 'green',
                            },
                          ]}
                        >
                  ...
                  ) : /* 3) REJECTED → show Total/paid/due + Change/New (from last rejected) */
                  isRejected &&
                    (rejectedDelta !== 0 || rejectedNewTotal > 0) ? (
                    <View>
                      <View style={styles.rowBetween}>
                        <Text style={styles.label}>Total Amount</Text>
                        <Text style={styles.amountBold}>
                      ...
                      <View style={styles.rowBetween}>
                        ...
                        <Text
                          style={[
                            styles.amountDue,
                            { color: rejectedDelta < 0 ? 'red' : 'green' },
                          ]}
                        >
                          {rejectedDelta < 0 ? '-' : '+'}{' '}
                          {currency(Math.abs(rejectedDelta))}
                        </Text>
                      </View>
                    ...
                    /* 4) NEVER EDITED (or last change rejected & no delta) → simple block */
                    <View>
                      <View style={styles.rowBetween}>
                        <Text style={styles.label}>Total Amount</Text>
                        <Text style={styles.amountBold}>
