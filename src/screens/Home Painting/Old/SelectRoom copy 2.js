...
const SelectRoom = () => {
  ...
  //     alive = false;
  //   };
  // }, [dupMode, sourceQuoteId, quoteId, hasInitial, applyMode, applyStage]);
  ...
  // const confirmDiscardAndLeave = proceed => {
  //   Alert.alert(
  //     'Discard changes?',
  ...
  //   if (isFocused) {
  //     // Handle back button when focused on SelectRoom
  //     confirmDiscardAndLeave(() => navigation.goBack()); // This ensures you go back to the previous screen (SelectRoom)
  //   }
