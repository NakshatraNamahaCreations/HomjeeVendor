...
// ✅ Fixes:
// 1) Split Fresh vs Repaint based on each measured section's mode
// 2) Apply putty add-on (must match SelectRoom) => PUTTY_RATE = 10
// 3) Do NOT merge Interior + Exterior rows (client issue) -> category included in key/label
// 4) Unique keys (no duplicate key warning)
